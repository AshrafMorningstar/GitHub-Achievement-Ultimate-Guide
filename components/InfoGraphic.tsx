...
const InfoGraphic: React.FC = () => {
  return (
    <div className="py-12 border-b border-github-border transition-colors duration-300">
       <div className="text-center mb-10">
           <h2 className="text-3xl font-bold text-github-text mb-4">Understanding the System</h2>
           <p className="text-github-muted">Two distinct families of decorations for your profile.</p>
       </div>

       <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Achievements Card */}
          <div className="bg-github-darker border border-github-border rounded-xl p-8 relative overflow-hidden group hover:border-github-blue transition-colors duration-300">
             ...
             <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-github-text">Achievements</h3>
             </div>
          ...
          {/* Highlights Card */}
          <div className="bg-github-darker border border-github-border rounded-xl p-8 relative overflow-hidden group hover:border-github-purple transition-colors duration-300">
             <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
             ...
             <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-github-text">Highlights</h3>
             </div>
             <ul className="space-y-3 text-github-text">
                <li className="flex items-start gap-2">
