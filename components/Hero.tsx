...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden border-b border-github-border bg-gradient-to-b from-github-darker to-github-dark pt-20 pb-16">
        ...
        <div className="flex justify-center items-center gap-6 flex-wrap mb-12">
          {showcaseBadges.map((badge) => (
            <div key={badge.id} className="group relative">
               <div className="w-16 h-16 md:w-20 md:h-20 bg-[#161b22] rounded-2xl flex items-center justify-center text-4xl border border-github-border group-hover:border-github-blue group-hover:-translate-y-2 transition-all duration-300 cursor-help shadow-xl group-hover:shadow-github-blue/20">
                 {badge.icon}
               </div>
               {/* Tooltip */}
